package com.elfennani.boardit.ui.screens.onboarding
...
fun NavController.navigateToOnBoarding(popUpToTop:Boolean = false){
    this.navigate(OnBoardingScreenPattern){
        if(popUpToTop){
            popUpTo(this@navigateToOnBoarding.currentBackStackEntry?.destination?.route ?: return@navigate){
                inclusive = true
            }
        }
    }
